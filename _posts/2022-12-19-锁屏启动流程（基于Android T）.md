...
img_path: assets/img/article/
---

# 锁屏启动流程（基于Android T）

锁屏开机大致分为两部分：第一部分是KeyguardViewMediator的启动；第二部分是从WindowManagerService开始，处理锁屏显示等流程。![1](two.jpg)
...
1. ### SystemUI启动到KeyguardViewMediator具体流程
...
1. ##### **com.android.server.SystemServer#main**
...
1. ##### **run()中调用了SystemServer#startOtherServices**
...
1. ##### **SystemServer#startSystemUi启动SystemUIService**
...
1. ##### **startSystemUi()启动SystemUiService**
